...
class DayNumAdapter(val context: Context, var listItem: ArrayList<String>): BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            if (convertView == null){
                view = mInflater.inflate(R.layout.item_spinner_day, parent, false)
        ...
        private class ItemRowHolder(row: View?){
            ...
            init {
                ...
                this.reletiveLayout = row.findViewById(R.id.llSpinnerx) as RelativeLayout
            }
        }
