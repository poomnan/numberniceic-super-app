    ...
    <div class="main-wrapper">
        <div class="card">
            <div class="card-header">
                ...
                <a href="/web/admin/temple" class="btn btn-white">&larr; กลับ</a>
            </div>
            <div class="card-body">
                <form action="/web/admin/temple/save" method="post" enctype="multipart/form-data">
                    ...
                    <div style="margin-top:2rem;">
                        ...
                        <a href="/web/admin/temple" class="btn btn-secondary">ยกเลิก</a>
                    </div>
                </form>
            </div>
        </div>
