...
class AuspiciousHistoryAdapter(
    private val items: List<InauspiciousData>,
    private val listener: OnItemClickListener
) : RecyclerView.Adapter<AuspiciousHistoryAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_inauspicious_history, parent, false) // Reuse layout
