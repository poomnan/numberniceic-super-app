        ...
        <div class="card">
            ...
            <div class="card-body">
                <div style="display:flex; justify-content:space-between; margin-bottom:1rem;">
                    ...
                    <a href="/web/admin/temple/add" class="btn btn-primary">+ เพิ่มวัดใหม่</a>
                </div>
                            ...
                            <?php else: ?>
                                <?php foreach ($items as $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/web/admin/temple/edit/<?= $item->id ?>"
                                                class="btn btn-warning btn-sm">แก้ไข</a>
                                            <a href="/web/admin/temple/delete/<?= $item->id ?>" class="btn btn-danger btn-sm"
