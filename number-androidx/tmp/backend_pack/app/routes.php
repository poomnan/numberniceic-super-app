...
// --- Admin & Assignments ---
$app->get('/admin/users/list', \App\Managers\AdminController::class . ':listUsersApi');
$app->post('/admin/member/update-status', \App\Managers\AdminController::class . ':updateUserStatusApi');
