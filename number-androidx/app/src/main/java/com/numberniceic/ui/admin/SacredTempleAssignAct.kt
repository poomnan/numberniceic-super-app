...
class SacredTempleAssignAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "เลือกผู้ใช้เพื่อแนะนำวัด"


        supportFragmentManager.beginTransaction().replace(R.id.buddha_assign_container,
                SacredTempleAssignF.newInstance(), "SacredTempleAssignF").commit()
