...
class InauspiciousAssignAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "เลือกผู้ใช้เพื่อจัดการวันอัปมงคล"


        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction().replace(R.id.buddha_assign_container,
                    InauspiciousAssignF.newInstance(), "InauspiciousAssignF").commit()
        }
    }
