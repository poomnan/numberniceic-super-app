...
<head>
    ...
    <title>จัดการขั้นตอนวิธีการทำบุญ (ปางพระ) - Admin Panel</title>
    <!-- Semantic UI CSS for consistency with other parts if needed, but local styles used primarily -->
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h1>🙏 จัดการข้อมูลขั้นตอนวิธีการทำบุญ</h1>
                ...
                foreach ($merits as $item): ?>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="/web/admin/merits/edit/<?php echo urlencode($item->file_name); ?>"
