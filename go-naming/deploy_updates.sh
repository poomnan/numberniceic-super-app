...
sshpass -p 'Lydh@58LTG' scp -o StrictHostKeyChecking=no go-naming-linux root@numberniceic.online:/home/tayap/go-naming/server_new

echo "🔧 Update and Restart on Remote..."
sshpass -p 'Lydh@58LTG' ssh -o StrictHostKeyChecking=no root@numberniceic.online "bash -c '
