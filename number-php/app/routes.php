...
// --- RengYam Tag Management ---
$app->get('/web/admin/rengyam-tags', \App\Managers\RengYamTagController::class . ':dashboard');
$app->get('/api/v1/rengyam/tags', \App\Managers\RengYamTagController::class . ':listTags');
$app->post('/web/admin/rengyam-tags/save', \App\Managers\RengYamTagController::class . ':saveTag');
$app->post('/web/admin/rengyam-tags/delete', \App\Managers\RengYamTagController::class . ':deleteTag');
