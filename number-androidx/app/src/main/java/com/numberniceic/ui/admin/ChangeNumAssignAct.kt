...
class ChangeNumAssignAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "เลือกผู้ใช้เพื่อส่งขั้นตอนการเปลี่ยนแปลง"


        supportFragmentManager.beginTransaction().replace(R.id.buddha_assign_container,
                ChangeNumAssignF.newInstance(), "ChangeNumAssignF").commit()
